...
<section>
    ...
    <thead>
        <tr>
            <th scope="col" style="border-bottom: 2px solid black;">unit</th>
    ...
    <tbody>
        <?php foreach($units as $unit): ?>
            <tr>
                ...
                <td> 
                    <a href="restore.php?id=<?=$unit['id']?>" class="btn btn-primary btn-sm">Restore</a>  
                    <a href="delete.php?id=<?=$unit['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
