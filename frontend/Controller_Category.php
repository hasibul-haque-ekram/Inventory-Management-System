            ...
            <div class="col-sm-10">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-2" ><button type="button" class="btn btn-danger">Add Category</button>
                        </div>
                ...
                <div class="row">
                    ...
                    <?php
                     include_once("../admin/components/partials/Category_Table.php");
                    ?>
                    <?php
                     include_once("../admin/components/partials/Elements_Table.php");
                    ?>
