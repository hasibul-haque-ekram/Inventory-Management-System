            ...
            <div class="col-sm-6">
               ...
               <a class="nav-link text-success" href="index.php">Lists</a>
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9"><?= $warehouse['warehouse'];?></dd>

                    <dt class="col-sm-3">Is Active:</dt>
                    <dd class="col-sm-9"><?= $warehouse['is_active'] ? "Active" : " Inactive" ;?></dd>

                    <!-- <dt class="col-sm-3">Status:</dt>
                    <dd class="col-sm-9"><?= $warehouse['status'];?></dd> -->
