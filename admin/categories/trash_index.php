...
$categories= $_category->trash_index();
    ...
    <tbody>
        <?php foreach($categories as $category): ?>
            <tr>
                ...
                <td> 
                    <a href="restore.php?id=<?=$category['id']?>" class="btn btn-primary btn-sm">Restore</a>  
                    <a href="delete.php?id=<?=$category['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
